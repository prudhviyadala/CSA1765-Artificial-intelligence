...
class Node:
    ...
    def __lt__(self, other):
        """This function is used for comparing nodes based on f value"""
...
def a_star(start, goal, graph, heuristic):
    ...
    :param graph: Dictionary with neighbors and their costs
    :param heuristic: Dictionary with heuristic values for each node
